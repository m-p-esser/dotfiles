...
export function sunburstSeries() {
  ...
  const _sunburstSeries = sunburstElement => {
    ...
    const label = segmentMerge.select("text").attr("fill-opacity", d => +labelVisible(d.current)).attr("transform", d => labelTransform(d.current, radius)).text(d => d.data.name).each(function (d) {
