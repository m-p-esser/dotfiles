...
export function colorRangeLegend() {
  ...
  function legend(container) {
    ...
    const svgBar = fc.autoBandwidth(fc.seriesSvgBar()).xScale(xScale).yScale(yScale).crossValue(0).baseValue((_, i) => i > 0 ? expandedDomain[i - 1] : 0).mainValue(d => d).decorate(selection => {
