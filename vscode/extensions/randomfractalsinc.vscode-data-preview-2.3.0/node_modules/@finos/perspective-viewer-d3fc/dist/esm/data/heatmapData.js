...
export function heatmapData(settings, data) {
  ...
  const mainType = axisType(settings).excludeType(AXIS_TYPES.linear).settingName("splitValues")();
  const heatmapData = [];
  data.forEach((col, i) => {
    const crossValue = labelfn(col, i);
    Object.keys(col).filter(key => key !== "__ROW_PATH__").forEach(key => {
...
//# sourceMappingURL=heatmapData.js.map