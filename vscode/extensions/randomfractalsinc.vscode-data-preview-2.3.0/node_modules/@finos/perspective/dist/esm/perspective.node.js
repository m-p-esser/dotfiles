...
let CLIENT_ID_GEN = 0;
const DEFAULT_ASSETS = ["@finos/perspective/dist/umd", "@finos/perspective-bench/dist", "@finos/perspective-viewer/dist/umd", "@finos/perspective-viewer-highcharts/dist/umd", "@finos/perspective-viewer-hypergrid/dist/umd", "@finos/perspective-viewer-d3fc/dist/umd"];
const CONTENT_TYPES = {
  ".js": "text/javascript",
  ".css": "text/css",
      ...
      if (host_psp || typeof host_psp === "undefined") {
        for (let rootDir of DEFAULT_ASSETS) {
          try {
            ...
            let filePath = RESOLVER(rootDir + url, {
              paths
            });
            let content = await read_promise(filePath);
...
class WebSocketServer extends Server {
  constructor({
    ...
    this.REQS = {};
    this.REQ_ID_MAP = new Map(); // Serve Worker API through WebSockets
    ...
    this._wss.on("connection", ws => {
      ...
      ws.on("message", msg => {
        ...
        msg = JSON.parse(msg);
        const compound_id = "".concat(msg.id, "/").concat(ws.id);
