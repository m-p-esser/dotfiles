...
const _wrapper = function _wrapper(f) {
...
export default require("datasaur-local").extend("PerspectiveDataModel", {
  isTreeCol: function isTreeCol(x) {
  ...
  setIsTree: function setIsTree(isTree) {
    this._isTree = isTree;
  },
  setDirty: function setDirty(nrows) {
    if (!this._grid) {
      return;
    }
  ...
  toggleRow: async function toggleRow(row, col, event) {
  ...
  _update_select_index: function _update_select_index() {
  ...
  _update_editor: function _update_editor(rect) {
  ...
  _update_selection: function _update_selection(new_index) {
    const has_cell_selections = this._grid.selectionModel.hasSelections();
  ...
  pspFetch: async function pspFetch(rect) {
  ...
  getCellEditorAt: function getCellEditorAt(columnIndex, rowIndex, declaredEditorName, options) {
  ...
  getCell: function getCell(config, rendererName) {
  ...
  clearSelectionState: function clearSelectionState() {
