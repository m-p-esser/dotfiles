...
function setEditorValueDate(x) {
  ...
  this.input.value = "".concat(now.getFullYear(), "-").concat(month, "-").concat(day);
...
function setEditorValueDatetime(x) {
  ...
  this.input.value = "".concat(now.getFullYear(), "-").concat(month, "-").concat(day, "T").concat(hour, ":").concat(minute, ":").concat(ss);
  this.input.addEventListener("keydown", keydown.bind(this));
}
