...
exports.prepareWebviewContent = void 0;
const vscode_1 = require("vscode");
const prepareWebviewContent = (panel, url) => {
    url.searchParams.set("app", "vscode");
    const vsCodeFontSize = vscode_1.workspace.getConfiguration(`editor`).get("fontSize", 14);
    ...
    const showUnsecuredConnectionWarning = vscode_1.workspace.getConfiguration(`msg.shell`)
        .get("showUnsecuredConnectionWarning", true);
    panel.webview.html = `
...
exports.prepareWebviewContent = prepareWebviewContent;
