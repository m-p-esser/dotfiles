...
exports.OciDbSystemHWTreeItem = void 0;
const path = __importStar(require("path"));
const vscode_1 = require("vscode");
const OciDbSystemTreeItem_1 = require("./OciDbSystemTreeItem");
class OciDbSystemHWTreeItem extends OciDbSystemTreeItem_1.OciDbSystemTreeItem {
    compartment;
    dbSystem;
    contextValue = "mdsDbSystemHW";
    constructor(profile, compartment, dbSystem) {
        super(profile, compartment, dbSystem, vscode_1.TreeItemCollapsibleState.Collapsed);
...
exports.OciDbSystemHWTreeItem = OciDbSystemHWTreeItem;
//# sourceMappingURL=OciDbSystemHWTreeItem.js.map