...
export interface IProtocolGuiParameters {
    ...
    [ShellAPIGui.GuiCoreSetLogLevel]: {
        args: {
            logLevel?: string;
        };
    };
    ...
    [ShellAPIGui.GuiCoreIsShellWebCertificateInstalled]: {
        kwargs?: IShellGuiCoreIsShellWebCertificateInstalledKwargs;
    };
    [ShellAPIGui.GuiCoreInstallShellWebCertificate]: {
        kwargs?: IShellGuiCoreInstallShellWebCertificateKwargs;
    };
    [ShellAPIGui.GuiCoreRemoveShellWebCertificate]: {};
    [ShellAPIGui.GuiDbconnectionsAddDbConnection]: {
        args: {
            profileId: number;
            connection: IShellDbConnection;
            folderPath?: string;
        };
    };
    ...
    [ShellAPIGui.GuiDbconnectionsGetDbConnection]: {
        args: {
    ...
    [ShellAPIGui.GuiDbconnectionsTestConnection]: {
        args: {
            connection: IShellDbConnection | number;
            password?: string;
        };
    };
    [ShellAPIGui.GuiDbconnectionsMoveConnection]: {
        args: {
            profileId: number;
            folderPath: string;
            connectionIdToMove: number;
            connectionIdOffset: number;
            before?: boolean;
        };
    };
    ...
    [ShellAPIGui.GuiShellStartSession]: {
        args: {
            dbConnectionId?: number;
            shellArgs?: unknown[];
        };
    ...
    [ShellAPIGui.GuiSqleditorOpenConnection]: {
        args: {
            dbConnectionId: number;
            moduleSessionId: string;
            password?: string;
    ...
    [ShellAPIGui.GuiSqleditorGetCurrentSchema]: {
        args: {
            moduleSessionId: string;
        };
    };
    ...
    [ShellAPIGui.GuiSqleditorGetAutoCommit]: {
        args: {
            moduleSessionId: string;
        };
    };
    ...
    [ShellAPIGui.GuiUsersGetGuiModuleList]: {
        args: {
            userId: number;
        };
    };
    [ShellAPIGui.GuiUsersListProfiles]: {
        args: {
            userId: number;
        };
    };
    [ShellAPIGui.GuiUsersGetProfile]: {
        args: {
            profileId: number;
        };
    };
    [ShellAPIGui.GuiUsersUpdateProfile]: {
        args: {
            profile: {
                id: number;
                name: string;
    ...
    [ShellAPIGui.GuiUsersAddProfile]: {
        args: {
            userId: number;
            profile: {
                name: string;
    ...
    [ShellAPIGui.GuiUsersGetDefaultProfile]: {
        args: {
            userId: number;
        };
    };
    ...
    [ShellAPIGui.GuiDebuggerGetScriptContent]: {
        args: {
            path: string;
        };
    };
    [ShellAPIGui.GuiModulesAddData]: {
        args: {
            caption: string;
            content: string;
    ...
    [ShellAPIGui.GuiModulesListData]: {
        args: {
            folderId: number;
            dataCategoryId?: number;
        };
    };
    [ShellAPIGui.GuiModulesGetDataContent]: {
        args: {
            id: number;
        };
    };
    ...
    [ShellAPIGui.GuiModulesListDataCategories]: {
        args: {
            categoryId?: number;
        };
    };
...
export declare type IShellFeedbackRequest = IShellTextFeedbackRequest | IShellConfirmFeedbackRequest | IShellSelectFeedbackRequest | IShellDirectoryFeedbackRequest | IShellFileSaveFeedbackRequest | IShellFileOpenFeedbackRequest | IShellPasswordFeedbackRequest;
...
export interface IProtocolGuiResults {
    ...
    [ShellAPIGui.GuiCoreValidatePath]: {};
    [ShellAPIGui.GuiCoreGetBackendInformation]: {
        result: IShellBackendInformation;
    };
    [ShellAPIGui.GuiCoreIsShellWebCertificateInstalled]: {};
    [ShellAPIGui.GuiCoreInstallShellWebCertificate]: {};
    [ShellAPIGui.GuiCoreRemoveShellWebCertificate]: {};
    ...
    [ShellAPIGui.GuiSqleditorCloseSession]: {};
    [ShellAPIGui.GuiSqleditorOpenConnection]: {
        result: IOpenConnectionData | IShellPasswordFeedbackRequest;
    };
    [ShellAPIGui.GuiSqleditorReconnect]: {};
    [ShellAPIGui.GuiSqleditorExecute]: {
        result: IDbEditorResultSetData;
    };
    [ShellAPIGui.GuiSqleditorKillQuery]: {};
    [ShellAPIGui.GuiSqleditorGetCurrentSchema]: {
        result: string;
...
export declare const multiResultAPIs: readonly [ShellAPIGui.GuiCoreListFiles, ShellAPIGui.GuiDbGetSchemaObjectNames, ShellAPIGui.GuiDbconnectionsListDbConnections, ShellAPIGui.GuiModulesGetProfileDataTree, ShellAPIGui.GuiShellComplete, ShellAPIGui.GuiSqleditorExecute, ShellAPIGui.GuiDbGetCatalogObjectNames, ShellAPIGui.GuiDbGetTableObjectNames];
