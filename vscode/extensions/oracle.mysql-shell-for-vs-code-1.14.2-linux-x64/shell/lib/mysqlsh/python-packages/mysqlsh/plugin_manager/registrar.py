...
def sql_handler(prefixes=None):
    """ Decorator to register a Custom SQL Handler in the MySQL Shell
    
    A Custom SQL Handler is function with the following syntax:
