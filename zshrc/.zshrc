...
export BITBUCKET_USER='marc-philipp.esser@lekkerland.com'
export DOTFILES="$GHREPOS/dotfiles"
export SECOND_BRAIN="$HOME/Documents/second_brain"
...
alias secbr='cd $SECOND_BRAIN'
alias deutils='cd $REPOS/data_engineering_utilities'
alias snow='cd OneDrive\ -\ Lekkerland/General\ -\ Snowflake/'
alias dcat='cd OneDrive\ -\ Lekkerland/General\ -\ Snowflake/Snowflake\ PROD/Input-Daten && explorer.exe analytics_data_catalog_v2.xlsm'
...
# see @https://github.com/davzoku/dotfiles/blob/master/zsh/.zshrc
